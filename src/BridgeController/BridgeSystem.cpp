...
BridgeSystem::BridgeSystem()
    : gates("Gates", gateActions, gateStates, 2), alarms("Alarms", alarmActions, alarmStates, 2), 
    trafficLights("TrafficLights", lightStates, 3), bridgeLights("BridgeLights", lightStates, 3), 
    mechanism("Bridge_Mechanism", mechActions, mechStates, 2), ultra0(), ultra1(), pir(), 
